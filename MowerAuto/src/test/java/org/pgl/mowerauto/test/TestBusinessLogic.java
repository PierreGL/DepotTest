...
public class TestBusinessLogic {
    ...
    public TestBusinessLogic() {
        ...
        uiManager.setOutput(UiMock.getInstance());
    ...
    public void testMoveOutGrass(){
        ...
        String expectedMoveOutMsg = String.format(bundle.getString("MSG_MOVE_OUT"), 1);
    ...
    public void testInitialOutGrass(){
        ...
        String expectedInitialOutMsg = String.format(bundle.getString("MSG_INITIAL_OUT"), 1);
    ...
    public void testMoveOccupiedCase(){
        ...
        String expectedMoveOccupied = String.format(bundle.getString("MSG_MOVE_OCCUPIED"), 2);
    ...
    public void testInitialOccupied(){
        ...
        String expectedInitialOccupiedMsg = String.format(bundle.getString("MSG_INITIAL_OCCUPIED"), 2);
