Description :
Ce programme permet de prendre en entrée un ou plusieurs fichiers décrivant l'action d'une tondeuse automatique sur un gazon.
...
-Une tondeuse ne peut pas être placée initiallement en dehors du gazon.
...
-Excepter dans cles cas pré-cités une tondeuse suite les instructions A=avancer, G=Tourner à gauche, D=Tourner à droite.
...
et l'internationalisation avec les librairies systemes.
Le projet est constitué des couches suivantes : "DAO" pour gérer l'accès aux fichier, "BUSINESS" pour la logique métier, "UI" pour la présentation.
...
Pour builder plus rapidement possibilité de taper "mvn install -P quick", les tests sont ignorés.
